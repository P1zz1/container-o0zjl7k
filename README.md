...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-o0zjl7k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-o0zjl7k.containers.anotherwebservice.com/
...
```
git clone git@github.com:P1zz1/container-o0zjl7k.git
cd container-o0zjl7k
```
...
```
docker attach container-o0zjl7k
```
